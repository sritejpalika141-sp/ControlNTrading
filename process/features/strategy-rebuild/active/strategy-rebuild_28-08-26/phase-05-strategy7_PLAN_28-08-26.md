---
name: plan:strategy-rebuild-phase-05-strategy7
description: "Strategy Rebuild — Phase 05: Strategy 7 — Audit"
date: 28-08-26
metadata:
  node_type: memory
  type: plan
...
**Report destination:** process/features/strategy-rebuild/active/strategy-rebuild_28-08-26/phase-05-strategy7_REPORT_{dd-mm-yy}.md (flat in the program task folder)

---

## Purpose

Audit-only pass on Strategy 7 (active strategy, Tier 2) to confirm entry/exit/SL logic is correct; apply minor cleanup if a bug is confirmed.
...
- Phase 4 complete (validated, committed)

---

## Blast Radius

- trading-app/engine/strategy_9.py (NOTE: verify exact file mapping for Strategy 7 during RESEARCH — file naming may not align 1:1 with strategy numbers; re-confirm against engine/ directory listing)
...
- Phase 04 exit gate not yet passed (strictly sequential program — this phase cannot start early)
...
- Selected plan file path:
  `process/features/strategy-rebuild/active/strategy-rebuild_28-08-26/phase-05-strategy7_PLAN_28-08-26.md`
- Last completed step: not started
- Validate-contract status: pending
- Next step: Spawn vc-research-agent for RESEARCH (Step 1) once Phase 04 is complete —
