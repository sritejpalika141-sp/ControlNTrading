...
description: "Strategy Rebuild — Phase 02: Strategy 3 (ORB) — Window Bug Fix"
date: 28-08-26
metadata:
  node_type: memory
  type: plan
...
# Phase 02 — Strategy 3 (ORB) — Window Bug Fix
...
Fix the confirmed call-site window bug limiting Strategy 3 to ~5 of its intended 70 minutes/day, per Phase 0 findings.
...
- Phase 1 complete (validated, committed)

---

## Blast Radius

- trading-app/workers/auto_trader.py — eval_strat_3()
...
- Phase 01 exit gate not yet passed (strictly sequential program — this phase cannot start early)
...
- Next step: Spawn vc-research-agent for RESEARCH (Step 1) once Phase 01 is complete —
